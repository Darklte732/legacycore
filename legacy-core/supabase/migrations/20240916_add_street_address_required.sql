-- Migration to add street address as a required field
-- This migration updates the existing check_required_application_fields function

-- Update the function to include street address check
