...
┌───────────────────────────────────────────────┐
│                                               │
│      LEGACYCORE EMERGENCY RECOVERY MODE       │
│                                               │
└───────────────────────────────────────────────┘
${colors.reset}`);
...
// Create a healthy status route for checking server health
app.get('/health', (req, res) => {
  res.status(200).json({ status: 'ok', mode: 'emergency-recovery' });
});

// Return the landing page for all routes
app.get('*', (req, res) => {
